...
现改用 potpourri3d 的 **flip-out 精确测地算法**（Sharp & Crane 2020）重算标签：
...
- scripts_local/：全部实验脚本（标签生成、消融驱动、报告与绘图、云端编排）
- ablation_ep_high/：解剖式消融工程
- baseline_ep_high/：三篇 baseline 对比工程
